...
module.exports = verifyLink => {
  return `<!DOCTYPE html>
    ...
    <body>
        <h1 style="font-size: 2.6rem; font-weight: bold;color: black;" class="display-4 text-center">Reset Your Password</h1>
        <div class="d-flex justify-content-center align-items-center">
            <div class="col-10">
                <hr>
            </div>
        </div>
        <p class="text-center small">Click Below to Reset Your Password</p>
