  ...
  return `<!DOCTYPE html>
    ...
    <head>
        ...
        *,::after,::before{box-sizing:border-box;}
        ...
        .col-1,.col-10,.col-md-12,.col-md-5,.col-md-7{position:relative;width:100%;min-height:1px;padding-right:15px;padding-left:15px;}
    ...
    <body>
        <h1 style="font-size: 2rem; font-weight: bold; color: black;" class="display-4 text-center">YOU HAVE A NEW MESSAGE</h1>
        <div class="background">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-10">
                    <h2 style="font-size: 2rem; font-weight: 400; color: black;" class=" ">Message Details</h2>
        ...
        shadow-sm  mb-2">
                        <div class="col-md-12 row-wrap mb-3">
                            <div class="row py-2 text-muted border-bottom">
                                ...
                                <div class="col-md-7">${message.name}</div>
                            </div>
                            <div class="row py-2 text-muted border-bottom">
                                <div class="col-md-5">SUBJECT</div>
                                <div class="col-md-7">${message.subject}</div>
                            </div>
                            <div class="row py-2 text-muted border-bottom">
                                <div class="col-md-5">EMAIL</div>
                                <div class="col-md-7">${message.email}</div>
                            </div>
                            <div class="row py-2 text-muted border-bottom">
                            ...
                            <div class="row py-2 text-muted border-bottom">
                                ...
                                <div class="col-md-7">${message.phone}</div>
                            </div>
